...
# This script conduct ran CAUSE analyses for MDD and GERD, as a sensitivity analysis.
...
X2 <- fread('/mnt/data1/user/chendongze/Project/MDD_GI_Project/disease_GERD.txt') # outcome
...
png('./cause_plot/CAUSE_MDD_GERD.png', res=300, height=2000, width=3500)
plot(res)
dev.off()

png('./cause_plot/CAUSE_MDD_GERD_data.png', res=300, height=2000, width=3500)
plot(res, type="data")
dev.off()
