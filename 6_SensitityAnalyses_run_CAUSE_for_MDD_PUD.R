...
# This script conduct ran CAUSE analyses for MDD and PUD, as a sensitivity analysis.
...
X2 <- fread('/mnt/data1/user/chendongze/Project/MDD_GI_Project/disease_PUD.txt') # outcome
...
r2_thresh = 0.01
pval_thresh = 1e-5 #should use larger p value, 1e-03 as used for posteriors, not 5e-08
# method1
...
png('./cause_plot/CAUSE_MDD_PUD_1e-5.png', res=300, height=2000, width=3500)
plot(res)
dev.off()

png('./cause_plot/CAUSE_MDD_PUD_data_1e-5.png', res=300, height=2000, width=3500)
plot(res, type="data")
dev.off()
